...
school.mgc - Create a magic file holberton.mgc that can be used with the command file to detect School data files. Holberton data files always contain the string SCHOOL at offset 0.
